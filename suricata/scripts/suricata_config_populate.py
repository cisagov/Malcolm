...
DEFAULT_VARS.update(
    {
        ...
        'METADATA_ALERT_FLOW_EVE_ENABLED': False,
        ...
        'SSH_HASSH': True,
        'SSH_ENCRYPTION_HANDLING': 'bypass',
        'SSH_PORTS': 22,
...
PROTOCOL_CONFIGS.update(
    {
        ...
        'doh2': ProtocolConfig(
            [],
            val2bool(DEFAULT_VARS['DOH2_ENABLED']),
            val2bool(DEFAULT_VARS['DOH2_EVE_ENABLED']),
            True,
            None,
            None,
        ),
        ...
        'ldap': ProtocolConfig(
            ['tcp', 'udp'],
            val2bool(DEFAULT_VARS['LDAP_ENABLED']),
            val2bool(DEFAULT_VARS['LDAP_EVE_ENABLED']),
            True,
            DEFAULT_VARS['LDAP_PORTS'],
            None,
        ),
        'mdns': ProtocolConfig(
            [],
            val2bool(DEFAULT_VARS['MDNS_ENABLED']),
            val2bool(DEFAULT_VARS['MDNS_EVE_ENABLED']),
            True,
            None,
            None,
        ),
        ...
        'pop3': ProtocolConfig(
            [],
            val2bool(DEFAULT_VARS['POP3_ENABLED']),
            val2bool(DEFAULT_VARS['POP3_EVE_ENABLED']),
            False,
            DEFAULT_VARS['POP3_PORTS'],
            None,
        ),
        'quic': ProtocolConfig(
            [],
        ...
        'websocket': ProtocolConfig(
            [],
            val2bool(DEFAULT_VARS['WEBSOCKET_ENABLED']),
            val2bool(DEFAULT_VARS['WEBSOCKET_EVE_ENABLED']),
            True,
            None,
            None,
        ),
...
def main():
    ...
    if captureIface is not None:
        ...
        for iface in captureIface.split(','):
            ifaceSettings = {
                ...
                'disable-hwtimestamp': not DEFAULT_VARS['AF_PACKET_HWTIMESTAMP'],
    ...
    for cfgKey in (
        ...
        ['app-layer', 'protocols', 'ssh', 'encryption-handling', 'SSH_ENCRYPTION_HANDLING'],
        ['app-layer', 'protocols', 'tls', 'ja3-fingerprints', 'TLS_JA3'],
        ['app-layer', 'protocols', 'tls', 'ja4-fingerprints', 'TLS_JA4'],
