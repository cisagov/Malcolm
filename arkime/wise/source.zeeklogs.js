...
class MalcolmSource extends WISESource {
  ...
  constructor(api, section) {
    ...
    var allFields = [
      ...
      "zeek.gquic.version",
      "zeek.hart_ip_common_commands.command_number_link_id",
      ...
      "zeek.hart_ip_direct_pdu_command.command_number_link_id",
      ...
      "zeek.hart_ip_direct_pdu_command.direct_pdu_command_link_id",
      "zeek.hart_ip_direct_pdu_command.direct_pdu_contents_response_response_code",
      "zeek.hart_ip_general.command_number_link_id",
      "zeek.hart_ip_general.direct_pdu_command_link_id",
      "zeek.hart_ip_general.direct_pdu_device_status_cold_start",
      "zeek.hart_ip_general.direct_pdu_device_status_configuration_changed",
      "zeek.hart_ip_general.direct_pdu_device_status_device_malfunction",
      "zeek.hart_ip_general.direct_pdu_device_status_loop_current_fixed",
      "zeek.hart_ip_general.direct_pdu_device_status_loop_current_saturated",
      "zeek.hart_ip_general.direct_pdu_device_status_more_status_available",
      "zeek.hart_ip_general.direct_pdu_device_status_non_primary_variable_out_of_limits",
      "zeek.hart_ip_general.direct_pdu_device_status_primary_variable_out_of_limits",
      "zeek.hart_ip_general.direct_pdu_extended_status_critical_power_failure",
      "zeek.hart_ip_general.direct_pdu_extended_status_device_variable_alert",
      "zeek.hart_ip_general.direct_pdu_extended_status_failure",
      "zeek.hart_ip_general.direct_pdu_extended_status_function_check",
      "zeek.hart_ip_general.direct_pdu_extended_status_maintenance_required",
      "zeek.hart_ip_general.direct_pdu_extended_status_out_of_specification",
      "zeek.hart_ip_general.direct_pdu_extended_status_undefined_bits",
      "zeek.hart_ip_general.header_length",
      "zeek.hart_ip_general.header_message_id",
      "zeek.hart_ip_general.header_message_type_message_type",
      "zeek.hart_ip_general.header_message_type_reserved",
      "zeek.hart_ip_general.header_sequence_number",
      "zeek.hart_ip_general.header_status_code",
      "zeek.hart_ip_general.header_version",
      "zeek.hart_ip_general.message_packet_bytes",
      "zeek.hart_ip_general.read_audit_log_last_security_change",
      "zeek.hart_ip_general.read_audit_log_number_of_records",
      "zeek.hart_ip_general.read_audit_log_power_up_time",
      "zeek.hart_ip_general.read_audit_log_server_status_insecure_syslog_connection",
      "zeek.hart_ip_general.read_audit_log_server_status_syslog_server_located_but_connection_failed",
      "zeek.hart_ip_general.read_audit_log_server_status_unable_to_locate_syslog_server",
      "zeek.hart_ip_general.read_audit_log_server_status_undefined_bits",
      "zeek.hart_ip_general.read_audit_log_session_record_size",
      "zeek.hart_ip_general.read_audit_log_start_record",
      "zeek.hart_ip_general.session_initiate_inactivity_close_timer",
      "zeek.hart_ip_general.session_initiate_master_type",
      "zeek.hart_ip_general.session_log_record_link_id",
      "zeek.hart_ip_general.token_passing_pdu_address_v4",
      "zeek.hart_ip_general.token_passing_pdu_address_v6",
      "zeek.hart_ip_general.token_passing_pdu_byte_count",
      "zeek.hart_ip_general.token_passing_pdu_check_byte",
      "zeek.hart_ip_general.token_passing_pdu_command_number",
      "zeek.hart_ip_general.token_passing_pdu_contents_data_data",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_cold_start",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_configuration_changed",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_device_malfunction",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_loop_current_fixed",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_loop_current_saturated",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_more_status_available",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_non_primary_variable_out_of_limits",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_device_status_primary_variable_out_of_limits",
      "zeek.hart_ip_general.token_passing_pdu_contents_response_response_code",
      "zeek.hart_ip_general.token_passing_pdu_delimiter_address_type",
      "zeek.hart_ip_general.token_passing_pdu_delimiter_expansion_bytes",
      "zeek.hart_ip_general.token_passing_pdu_delimiter_frame_type",
      "zeek.hart_ip_general.token_passing_pdu_delimiter_physical_layer_type",
      ...
      "zeek.hart_ip_session_record.session_log_record_link_id",
      ...
      "zeek.hart_ip_universal_commands.command_number_link_id",
