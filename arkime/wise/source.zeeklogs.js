...
class ZeekSource extends WISESource {
  ...
  constructor (api, section) {
    ...
    var allFields = [
      ...
      "zeek_ntp.version",
      "zeek_ntp.xmt_time",
      "zeek_ocsp.certStatus",
      "zeek_ocsp.hashAlgorithm",
      "zeek_ocsp.issuerKeyHash",
      "zeek_ocsp.issuerNameHash",
      "zeek_ocsp.nextUpdate",
      "zeek_ocsp.revokereason",
      "zeek_ocsp.revoketime",
      "zeek_ocsp.serialNumber",
      "zeek_ocsp.thisUpdate",
      "zeek_pe.compile_ts",
      ...
      "zeek_ssh.sshka",
      "zeek_ssh.version",
      "zeek_ssl.cert_chain_fps",
      "zeek_ssl.cert_chain_fuids",
      "zeek_ssl.cipher",
      "zeek_ssl.client_cert_chain_fps",
      ...
      "zeek_stun.method",
      "zeek_stun.trans_id",
      "zeek_stun_nat.is_orig",
      "zeek_stun_nat.lan_addr",
      "zeek_stun_nat.wan_addr",
      "zeek_stun_nat.wan_port",
    ...
    this.api.addValueAction("malcolm_dashbaords_cat_ip",       {name:filterLabel, url:"idark2kib/filter?start=%ISOSTART%&stop=%ISOSTOP%&field=%DBFIELD%&value=%TEXT%", category:"ip"});
    this.api.addValueAction("malcolm_dashbaords_cat_port",     {name:filterLabel, url:filterUrl, category:"port"});
    this.api.addValueAction("malcolm_dashbaords_cat_country",  {name:filterLabel, url:filterUrl, category:"country"});
    this.api.addValueAction("malcolm_dashbaords_cat_host",     {name:filterLabel, url:filterUrl, category:"host"});
    this.api.addValueAction("malcolm_dashbaords_cat_md5",      {name:filterLabel, url:filterUrl, category:"md5"});
    this.api.addValueAction("malcolm_dashbaords_cat_user",     {name:filterLabel, url:filterUrl, category:"user"});
    this.api.addValueAction("malcolm_dashbaords_fields_zeek",  {name:filterLabel, url:filterUrl, fields:allFieldsStr});
