...
# to Malcolm (see https://github.com/cisagov/Malcolm/tree/main/scripts/beats)
...
function Download-Beat {
  ...
  Invoke-WebRequest -UseBasicParsing -OutFile "C:\\Program Files\\$beat\\$beat.yml" -Uri https://raw.githubusercontent.com/cisagov/Malcolm/main/scripts/beats/windows_vm_example/$beat.yml
