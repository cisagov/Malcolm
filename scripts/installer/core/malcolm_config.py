...
class MalcolmConfig(ObservableStoreMixin):
        ...
        try:
            for filename, values in env_files_content.items():
                ...
                with open(filepath, "w") as f:
                    f.write(f"# This file was auto-generated by the Malcolm installer on {datetime.datetime.now()}.\n")
                    f.write(
    ...
    def generate_docker_compose_file(
        ...
        try:
            ...
            y2 = yamlImported.YAML(typ="safe", pure=True)
    ...
    def _apply_docker_config_to_compose(self, compose_data: Dict[str, Any]):
        ...
        if restart_policy is not None:
            final_restart_policy = restart_policy.value if isinstance(restart_policy, Enum) else str(restart_policy)
        elif auto_restart:
    ...
    def generate_all_config_files(
        ...
        self.generate_docker_compose_file(config_dir, template_path=docker_compose_template_path)
