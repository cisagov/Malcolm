...
KEY_CONFIG_ITEM_PCAP_NET_SNIFF = "pcapNetSniff"
KEY_CONFIG_ITEM_PCAP_TCP_DUMP = "pcapTcpDump"
KEY_CONFIG_ITEM_LIVE_ZEEK = "liveZeek"
KEY_CONFIG_ITEM_LIVE_SURICATA = "liveSuricata"
KEY_CONFIG_ITEM_PCAP_NODE_NAME = "pcapNodeName"

# Docker options
KEY_CONFIG_ITEM_MALCOLM_AUTO_RESTART = "malcolmAutoRestart"
...
KEY_CONFIG_ITEM_DOCKER_EXTRA_USERS = "dockerExtraUsers"
KEY_CONFIG_ITEM_PROCESS_GROUP_ID = "processGroupId"
KEY_CONFIG_ITEM_PROCESS_USER_ID = "processUserId"

# Filebeat options
KEY_CONFIG_ITEM_FILEBEAT_TCP_OPEN = "filebeatTcpOpen"
...
KEY_CONFIG_ITEM_NETBOX_LOGSTASH_AUTO_SUBNETS = "netboxLogstashAutoSubnets"
KEY_CONFIG_ITEM_NETBOX_SITE_NAME = "netboxSiteName"
KEY_CONFIG_ITEM_NETBOX_URL = "netboxUrl"

# Network options
KEY_CONFIG_ITEM_NGINX_SSL = "nginxSSL"
KEY_CONFIG_ITEM_NGINX_RESOLVER_IPV4_OFF = "nginxResolverIpv4Off"
KEY_CONFIG_ITEM_NGINX_RESOLVER_IPV6_OFF = "nginxResolverIpv6Off"
KEY_CONFIG_ITEM_BEHIND_REVERSE_PROXY = "behindReverseProxy"
...
KEY_CONFIG_ITEM_ACCEPT_STANDARD_SYSLOG_MESSAGES = "acceptStandardSyslogMessages"
...
# KEY_CONFIG_ITEM_INDEX_SNAPSHOT_COMPRESSED = "indexSnapshotCompressed" # TODO: determine if this is needed
