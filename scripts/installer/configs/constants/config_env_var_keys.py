...
KEY_ENV_NGINX_RESOLVER_IPV4_OFF = "NGINX_RESOLVER_IPV4_OFF"  # "off" parameters for IPv4/IPv6 for NGINX resolver
KEY_ENV_NGINX_RESOLVER_IPV6_OFF = "NGINX_RESOLVER_IPV6_OFF"

KEY_ENV_OPENSEARCH_INDEX_SIZE_PRUNE_LIMIT = "OPENSEARCH_INDEX_SIZE_PRUNE_LIMIT"  # delete based on index pattern size
