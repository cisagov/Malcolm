...
FILES_IN_IMAGES=(
  ...
  "/data/arkime/etc/GeoLite2-ASN.mmdb;arkime"
  "/data/arkime/etc/GeoLite2-Country.mmdb;arkime"
  "/data/arkime/etc/ipv4-address-space.csv;arkime"
  "/data/arkime/etc/oui.txt;arkime"
  "/data/arkime/bin/arkime-capture;arkime"
