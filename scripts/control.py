    ...
    if orchMode is OrchestrationFramework.DOCKER_COMPOSE:
        ...
        if wipe:
            ...
            boundPathsToWipe = (
                ...
                BoundPath("upload", "/var/www/upload/server/php/chroot/files", True, ["tmp", "variants"], None),
...
def start():
    ...
    if orchMode is OrchestrationFramework.DOCKER_COMPOSE:
        ...
        boundPathsToCreate = (
            ...
            BoundPath("upload", "/var/www/upload/server/php/chroot/files", False, ["tmp", "variants"], None),
