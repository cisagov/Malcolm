...
def upload_file_to_malass(upload_file_path, web_server_ip="127.0.0.1", web_server_port="80"):
    ...
    with open(upload_file_path, "rb") as upload_file_handle:
        error_code, error_msg1, headers, resp_str = post_multipart(
            url=f"http://{web_server_ip}:{web_server_port}/cgi-bin/file_upload.py",
...
################################################################################
def query_av_summary_rpt(transaction_id, uploaded_file_name="", web_server_ip="127.0.0.1", web_server_port="80"):
    ...
    error_code, error_msg1, headers, resp_str = post_multipart(
        url=f"http://{web_server_ip}:{web_server_port}/cgi-bin/query_av_summary_rpt.py",
