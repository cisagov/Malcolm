...
ZKG_GITHUB_URLS=(
  ...
  "https://github.com/mmguero-dev/icsnpp-bacnet|zeek-v4.1-compatibility"
  "https://github.com/mmguero-dev/icsnpp-bsap|zeek-v4.1-compatibility"
  "https://github.com/cisagov/icsnpp-dnp3"
  "https://github.com/mmguero-dev/icsnpp-enip|zeek-v4.1-compatibility"
  "https://github.com/mmguero-dev/icsnpp-ethercat|zeek-v4.1-compatibility"
  ...
  "https://github.com/mmguero-dev/zeek-httpattacks|zeek-v4.1-compatibility"
