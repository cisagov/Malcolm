...
ZKG_GITHUB_URLS=(
  ...
  "https://github.com/mmguero-dev/zeek-spicy-ipsec"
  "https://github.com/mmguero-dev/zeek-spicy-openvpn"
  "https://github.com/mmguero-dev/zeek-spicy-ospf"
  "https://github.com/mmguero-dev/zeek-spicy-stun"
  "https://github.com/mmguero-dev/zeek-spicy-wireguard"
