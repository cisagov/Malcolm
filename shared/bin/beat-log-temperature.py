...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='beat-log-temperature.py', add_help=False, usage='temperature.py [options]'
    )
    parser.add_argument(
        '-p',
        '--port',
        ...
        type=int,
        nargs='?',
        default=BEAT_PORT_DEFAULT,
        help='UDP port monitored by protologbeat',
    )
    parser.add_argument(
        '-c',
        '--count',
        ...
        nargs='?',
        default=1,
        help='Number of times to execute (default = 1, 0 = loop forever)',
    )
    parser.add_argument(
        '-s',
        '--sleep',
        ...
        nargs='?',
        default=10,
        help='Seconds between iterations if looping (default = 10)',
    )
    parser.add_argument(
