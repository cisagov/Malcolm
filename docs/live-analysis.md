...
- `ARKIME_PACKET_THREADS` - the [number of packet threads](https://arkime.com/settings#packetThreads) used to process packets after the reader has received the packets
