...
LOGO_URL = 'https://raw.githubusercontent.com/idaholab/Malcolm/development/docs/images/logo/Malcolm_reflection_white.png'
...
# (translatable)
CONTENT_FOOTER = 'This site mirrors the documentation of <a href="https://github.com/idaholab/Malcolm">Malcolm</a>, an open-source project developed at <a href="https://github.com/idaholab/">INL</a> and funded by <a href="https://www.dhs.gov/">DHS</a>. This site is not operated by INL nor DHS: its content is the sole responsibility of <a href="mailto:{email}">its maintainer</a>. See {license} for Malcolm\'s license terms.'
