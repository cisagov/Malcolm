...
* [Deploying Malcolm on Amazon Web Services (AWS)](aws.md#AWS)
    - [Installing Malcolm in an EC2 instance on Amazon Web Services (AWS)](aws.md#AWSEC2)
    - [Installing Malcolm on Amazon Web Services (AWS) Fargate](aws.md#AWSFargate)
    - [Deploying Malcolm on Amazon Elastic Kubernetes Service (EKS)](aws.md#KubernetesEKS)
    - [Generating a Malcolm Amazon Machine Image (AMI) for Use on Amazon Web Services (AWS)](aws.md#AWSAMI)
