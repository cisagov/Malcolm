...
* [Deploying Malcolm in Other Third-Party Environments](third-party-envs.md#ThirdPartyEnv)
    - [Installing Malcolm in an EC2 instance on Amazon Web Services (AWS)](third-party-envs.md#AWSEC2)
    - [Installing Malcolm on Amazon Web Services (AWS) Fargate](third-party-envs.md#AWSFargate)
    - [Generating a Malcolm Amazon Machine Image (AMI) for Use on Amazon Web Services (AWS)](third-party-envs.md#AWSAMI)
