...
* **`filescan.env`** and **`pipeline.env`** - Settings related to [scanning of automatically-extracted files observed in traffic](file-scanning.md#ZeekFileExtraction) (see also **`zeek.env`** below)
