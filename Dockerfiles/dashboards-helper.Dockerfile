...
ARG DASHBOARDS_OFFLINE_REGION_MAPS_PORT="28991"
...
ENV DASHBOARDS_OFFLINE_REGION_MAPS_PORT $DASHBOARDS_OFFLINE_REGION_MAPS_PORT
...
EXPOSE $DASHBOARDS_OFFLINE_REGION_MAPS_PORT
