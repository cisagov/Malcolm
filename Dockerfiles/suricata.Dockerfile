...
ARG SURICATA_STATS_ENABLED=false
ARG SURICATA_STATS_EVE_ENABLED=false
...
ENV SURICATA_STATS_ENABLED $SURICATA_STATS_ENABLED
ENV SURICATA_STATS_EVE_ENABLED $SURICATA_STATS_EVE_ENABLED
