...
ARG PCAP_PATH=/pcap
ARG PCAP_PATH_UPLOAD_SUBDIR=upload
ARG PCAP_PATH_PROCESSED_SUBDIR=processed
...
ARG WATCHER_UPLOAD=true
ARG WATCHER_PUBLISH=true
ARG ZEEK_PATH=/zeek
ARG ZEEK_PATH_UPLOAD_SUBDIR=upload

ENV PCAP_PATH $PCAP_PATH
ENV PCAP_PATH_UPLOAD_SUBDIR $PCAP_PATH_UPLOAD_SUBDIR
ENV PCAP_PATH_PROCESSED_SUBDIR $PCAP_PATH_PROCESSED_SUBDIR
...
ENV WATCHER_UPLOAD $WATCHER_UPLOAD
ENV WATCHER_PUBLISH $WATCHER_PUBLISH
ENV ZEEK_PATH $ZEEK_PATH
ENV ZEEK_PATH_UPLOAD_SUBDIR $ZEEK_PATH_UPLOAD_SUBDIR
