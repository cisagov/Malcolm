...
RUN export BINARCH=$(uname -m | sed 's/x86_64/amd64/' | sed 's/aarch64/arm64/') && \
    ...
    #     sed -i "s/2\.16\.0/2\.16\.0/g" opensearch-dashboards/transformVis/opensearch_dashboards.json && \
    #     sed -i "s/2\.16\.0/2\.16\.0/g" opensearch-dashboards/transformVis/package.json && \
