...
ARG OPENSEARCH_HOST=opensearch
ARG OPENSEARCH_PORT=9200
ARG OPENSEARCH_PROTOCOL=http
...
ENV OPENSEARCH_PROTOCOL $OPENSEARCH_PROTOCOL
ENV OPENSEARCH_URL $OPENSEARCH_PROTOCOL"://"$OPENSEARCH_HOST":"$OPENSEARCH_PORT
