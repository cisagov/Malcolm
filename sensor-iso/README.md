...
```
…
Finished, created "/sensor-build/hedgehog-2.1.1.iso"
…
```
...
zeek_3.0.7-1_amd64.deb                                                          100%   26MB  63.1MB/s   00:00
```
...
Preparing to unpack .../zeek_3.0.7-1_amd64.deb ...
Unpacking zeek (3.0.7-1) over (3.0.0-1) ...
