...
```
…
Finished, created "/sensor-build/hedgehog-4.0.1.iso"
…
```
...
Hedgehog Linux - part of [Malcolm](https://github.com/idaholab/Malcolm) - is Copyright 2021 Battelle Energy Alliance, LLC, and is developed and released through the cooperation of the Idaho National Laboratory of the U.S. Department of Homeland Security.
