function DialogBox(a, b, c, d, e) {
    ...
    var g = $('<div id="modal_overlay" style="display:none;"></div>'), h = $('<div class="modal"></div>');
    ...
    this.version = 0, this.isEditing = ko.observable(!1), this.allow_edit = ko.observable(!1), this.allow_edit.subscribe(function (a) {
        ...
        read: function () {
            ...
            return _.each(a, function (a) {
                var c = a.type_name, d = c;
                _.isUndefined(a.display_name) || (d = a.display_name), b.push({name: c, display_name: d})
            }), b
        }
        ...
        read: function () {
            ...
            return _.each(b, function (b) {
                var c = b.type_name, d = c;
                _.isUndefined(b.display_name) || (d = b.display_name), a.push({name: c, display_name: d})
            }), a
        }
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            a.type = "file", $(a).on("change", function (a) {
                ...
                if (b && b.length > 0) {
                    var c = b[0], e = new FileReader;
                    e.addEventListener("load", function (a) {
                        var b = a.target, c = JSON.parse(b.result);
        ...
        var a = $(event.currentTarget), b = a.data("siblings-shown") || !1;
        ...
        var c = $(b.currentTarget).data("pretty"), e = "application/octet-stream", f = document.createElement("a");
        if (c) var g = new Blob([JSON.stringify(d.serialize(), null, "	")], {type: e}); else var g = new Blob([JSON.stringify(d.serialize())], {type: e});
        ...
        if (d.allow_edit() || !a) {
            ...
            var e = b ? 250 : 0, f = $("#admin-bar").outerHeight();
...
function FreeboardUI() {
    function a(a) {
        ...
        a && (c = function (a) {
            var c = this, d = ko.dataFor(c), e = q(d);
    ...
    function b(a) {
        ...
        f(b) && g(function () {
            ...
            if (a) {
                ...
                b = {row: g, col: h}
            } else rightPreviewCol = !0, b = {row: g, col: f};
    ...
    function d() {
        var a = $(".column-tool"), b = $("#board-content").width(), c = Math.floor(b / v);
    ...
    function j(a, b, c) {
        var d = q(b), e = d.col, f = d.row, g = Number(b.width()), h = Number(b.getCalculatedHeight());
        r.add_widget(a, g, h, e, f), c && n(!0), l(b, f, e), $(a).attrchange({
            trackValues: !0, callback: function (a) {
    ...
    function k(a, b) {
        var c = b.getCalculatedHeight(), d = Number($(a).attr("data-sizey")), e = Number($(a).attr("data-sizex"));
    ...
    function q(a) {
        ...
        var d = 1, e = 1e3;
        for (var f in a.col) {
            if (f == b) return {row: a.row[f], col: a.col[f]};
            if (a.col[f] > b) d = b; else {
                var g = b - f;
                e > g && (d = f, e = g)
            }
        }
...
function PaneModel(a, b) {
    ...
    this.title = ko.observable(), this.width = ko.observable(1), this.row = {}, this.col = {}, this.col_width = ko.observable(1), this.col_width.subscribe(function (a) {
        ...
        if (c.widgetCanMoveUp(a)) {
            var b = c.widgets.indexOf(a), d = c.widgets();
        ...
        return _.each(c.widgets(), function (b) {
            a.push(b.serialize())
        }), {title: c.title(), width: c.width(), row: c.row, col: c.col, col_width: c.col_width(), widgets: a}
...
function WidgetModel(a, b) {
    ...
    this.datasourceRefreshNotifications = {}, this.calculatedSettingScripts = {}, this.title = ko.observable(), this.fillSize = ko.observable(!1), this.type = ko.observable(), this.type.subscribe(function (a) {
        ...
        if (d.datasourceRefreshNotifications = {}, d.calculatedSettingScripts = {}, !_.isUndefined(d.type())) {
            var a = b[d.type()].settings, c = new RegExp("datasources.([\\w_-]+)|datasources\\[['\"]([^'\"]+)", "g"),
                e = d.settings();
            _.each(a, function (a) {
                if ("calculated" == a.type) {
                    ...
                    if (!_.isUndefined(b)) {
                        ...
                        for (var i; i = c.exec(b);) {
                            var j = i[1] || i[2], k = d.datasourceRefreshNotifications[j];
...
DatasourceModel = function (a, b) {
    ...
    this.name = ko.observable(), this.latestData = ko.observable(), this.settings = ko.observable({}), this.settings.subscribe(function (a) {
        ...
        return {name: d.name(), type: d.type(), settings: d.settings()}
    }, this.deserialize = function (a) {
    ...
    function b() {
        function b(a) {
            var b = $("<tr></tr>"), d = $('<ul class="board-toolbar"></ul>'),
        ...
        var c = [], d = $("<div></div>"), e = $('<div class="table-operation text-button">ADD</div>'),
    ...
    function b(a, b) {
        ...
        a || (a = c);
        var d = $('<div class="code-window"></div>'), e = $('<div class="code-mirror-wrapper"></div>'),
    ...
    function g(a, b, g, h, i) {
                ...
                switch (a.type) {
                    case"array":
                        var k = $('<div class="form-table-value-subtable"></div>').appendTo(i),
                            ...
                            n = $("<thead></thead>").hide().appendTo(l), o = $("<tr></tr>").appendTo(n),
                            p = $("<tbody></tbody>").appendTo(l), q = [];
                    ...
                    default:
                        if (m.settings[a.name] = h[a.name], "calculated" == a.type) {
                            if (a.name in h) {
                                var u = h[a.name];
                                if (a.multi_input && _.isArray(u)) for (var v = !1, w = 0; w < u.length; w++) f(i, m, a, u[w], v), v = !0; else f(i, m, a, u, !1)
                            } else f(i, m, a, null, !1);
                            if (a.multi_input) {
                            ...
                            if (a.name in h && s.val(h[a.name]), b && a.typeahead_data_field && s.addClass("typeahead_data_field-" + a.typeahead_data_field), b && a.typeahead_field) {
                                ...
                                s.keyup(function (a) {
                                    ...
                                    source: y, select: function (a, b) {
                                        s.val(b.item.value), s.trigger("change")
                                    }
                                }), s.change(function (d) {
                                    var e = s.val(), f = _.template(b)({input: e});
                                    $.get(f, function (b) {
                                        if (c && (b = b[c]), b = _.select(b, function (b) {
                                            ...
                                            for (var d in b) if (b.hasOwnProperty(d)) {
                                                var f = $(_.template("input.typeahead_data_field-<%= field %>")({field: d}));
        ...
        var l, m = {type: g, settings: {}}, n = $("<div></div>"), o = $('<div id="plugin-description"></div>').hide();
    ...
    function e(a) {
        var b = ($(a).val().match(/\n/g) || []).length, c = Math.min(200, 20 * (b + 1));
        $(a).css({height: c + "px"})
    }

    function f(a, c, d) {
        var e = j.exec(a), f = [];
        if (e) if ("" == e[1]) _.each(c, function (a) {
            f.push({value: a.name(), entity: void 0, precede_char: "", follow_char: '"]'})
        }); else if ("" != e[1] && _.isUndefined(e[2])) {
            var g = e[1];
            _.each(c, function (a) {
                var b = a.name();
                b != g && 0 == b.indexOf(g) && f.push({value: b, entity: void 0, precede_char: "", follow_char: '"]'})
            })
        } else {
            ...
            if (!_.isUndefined(h)) {
                ...
                if (n = o, _.isArray(o)) {
                    for (var p = 0; p < o.length; p++) if (0 == p.toString().indexOf(k)) {
                        var q = o[p];
                        b(q, d) && f.push({
                            value: p,
                            entity: q,
                    ...
                    0 == c.indexOf(k) && b(a, d) && f.push({value: c, entity: a, precede_char: '["', follow_char: '"]'})
                })
            }
        }
        m = f
    ...
    function h(a, b, c, d) {
        ...
        var f = $("<li>" + e + "</li>").appendTo(k).mouseenter(function () {
            ...
            var e = b.lastIndexOf("]");
            -1 != e ? $(a).replaceTextAt(e + 1, $(a).val().length, d) : $(a).insertAtCaret(d), n = c.entity, $(a).triggerHandler("mouseup")
    ...
    function i(a, b) {
        $(a).addClass("calculated-value-input").bind("keyup mouseup freeboard-eval", function (c) {
            ...
            $(a).css({"z-index": 3001}), e(a)
        }).focusout(function () {
            d(a, b), $(a).css({height: "", "z-index": 3e3}), $(a).next("ul#value-selector").remove(), k = null, l = -1
        }).bind("keydown", function (a) {
            if (k) if (38 == a.keyCode || 40 == a.keyCode) {
                a.preventDefault();
                var b = $(k).find("li");
    ...
    var j = new RegExp('.*datasources\\["([^"]*)("\\])?(.*)$'), k = null, l = 0, m = [], n = null,
        o = {ANY: "any", ARRAY: "array", OBJECT: "object", STRING: "string", NUMBER: "number", BOOLEAN: "boolean"};
    return {
    ...
    a.fn.attrchange = function (e) {
        var f = {trackValues: !1, callback: a.noop};
        if ("function" == typeof e ? f.callback = e : a.extend(f, e), f.trackValues && a(this).each(function (b, c) {
            ...
            var g = {subtree: !1, attributes: !0, attributeOldValue: f.trackValues}, h = new d(function (b) {
...
var freeboard = function () {
    ...
    var b = {}, c = {}, d = new FreeboardUI, e = new FreeboardModel(b, c, d), f = new JSEditor, g = new ValueEditor(e),
        h = new PluginEditor(f, g), i = new DeveloperConsole(e), j = {
            values: {
                "font-family": '"HelveticaNeue-UltraLight", "Helvetica Neue Ultra Light", "Helvetica Neue", sans-serif',
                color: "#d3d4d4", "font-weight": 100
            }
        };
    return ko.bindingHandlers.pluginEditor = {
        init: function (a, f, g, i, j) {
            var k = ko.unwrap(f()), l = {}, m = void 0, n = "";
        ...
        init: function (a, b, c, f, g) {
            e.isEditing() && $(a).css({cursor: "pointer"}), d.addPane(a, f, g.$root.isEditing())
        ...
        initialize: function (b, c) {
            ...
            var b = e.datasources(), c = _.find(b, function (b) {
                return b.name() === a
            });
            return c ? c.settings() : null
        }, setDatasourceSettings: function (a, b) {
            var c = e.datasources(), d = _.find(c, function (b) {
                return b.name() === a
            });
