...
global c122_authentication_value = (getenv("ZEEK_C1222_AUTHENTICATION_VALUE") == true_regex) ? T : F;
global c122_identification_service =(getenv("ZEEK_C1222_IDENTIFICATION_SERVICE") == true_regex) ? T : F;
global c122_read_write_service = (getenv("ZEEK_C1222_READ_WRITE_SERVICE") == true_regex) ? T : F;
global c122_logon_security_service =(getenv("ZEEK_C1222_LOGON_SECURITY_SERVICE") == true_regex) ? T : F;
global c122_wait_service =(getenv("ZEEK_C1222_WAIT_SERVICE") == true_regex) ? T : F;
global c122_dereg_reg_service = (getenv("ZEEK_C1222_DEREG_REG_SERVICE") == true_regex) ? T : F;
global c122_resolve_service = (getenv("ZEEK_C1222_RESOLVE_SERVICE") == true_regex) ? T : F;
global c122_trace_service = (getenv("ZEEK_C1222_TRACE_SERVICE") == true_regex) ? T : F;
